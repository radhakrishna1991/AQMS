...
(function (jsGrid, $, undefined) {
    ...
    SelectField.prototype = new NumberField({
        ...
        _createSelect: function (selected) {
            var $result = $("<select class='form-select' >"),
                valueField = this.valueField,
                textField = this.textField,
...
(function (jsGrid, $, undefined) {
    ...
    SelectField.prototype = new NumberField({
        ...
        filterTemplate: function () {
            ...
            var grid = this._grid,
                $result = this.filterControl = this._createSelect1();
            setTimeout(function () {
                $result = $('select[multiple]').multiselect({
        ...
        insertTemplate: function () {
            ...
            return this.insertControl = this._createSelect1();
        },
        ...
        editTemplate: function (value) {
            ...
            var $result = this.editControl = this._createSelect1();
            (value !== undefined) && $result.val(value);
            return $result;
        },
        ...
        filterValue: function () {
            var val = this.filterControl.val();
            // console.log(this.valueType === numberValueType ? parseInt(val || 0, 10) : val);
        ...
        _createSelect1: function (selected) {
            var $result = $("<select name='myarray[]' class='form-select' multiple='multiple'>"),
                valueField = this.valueField,
                textField = this.textField,
                selectedIndex = this.selectedIndex;
    ...
    jsGrid.fields.multiselect = jsGrid.SelectField = SelectField;
