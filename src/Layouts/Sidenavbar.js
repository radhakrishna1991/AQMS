 ...
 {/*  <li className="nav-item">
  ...
  <li className="nav-item">
    ...
    <ul id="configuration-nav" className="nav-content collapse" data-bs-parent="#sidebar-nav">
      <li>
        <a className="animation-forwards animate-delay-1" href="components-alerts.html">
      ...
      <li>
        <a className="animation-forwards animate-delay-2" href="components-accordion.html">
          <i className="bi bi-circle"></i><span className="animate-fill-mode-forwards">Favorites Editors - All Users</span>
        </a>
      </li>
      <li>
        <a className="animation-forwards animate-delay-3" href="components-badges.html">
          <i className="bi bi-circle"></i><span className="animate-fill-mode-forwards">Gsi/Modbus Drivers</span>
        </a>
      </li>
      <li>
        <a className="animation-forwards animate-delay-4" href="components-breadcrumbs.html">
      ...
      <li>
        <a className="animation-forwards animate-delay-6" href="components-buttons.html">
      ...
      <li>
        <a className="animation-forwards animate-delay-8" href="components-buttons.html">
          <i className="bi bi-circle"></i><span>PC Configuration</span>
        </a>
      </li>
        <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-9" data-bs-target="#configuration-nav-sub" data-bs-toggle="collapse" href="#">
      ...
      <li>
        <a className="animation-forwards animate-delay-2" href="components-buttons.html">
          ...
          <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-10" data-bs-target="#configuration-nav-sub1" data-bs-toggle="collapse" href="#">
      ...
      <li>
        <a className="animation-forwards animate-delay-11" href="components-buttons.html">
  ...
  <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-3" data-bs-target="#Data-nav" data-bs-toggle="collapse" href="#">
  ...
  <li className="nav-item">
    ...
    <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-1" data-bs-target="#report-nav-sub" data-bs-toggle="collapse" href="#">
  ...
  <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-2" data-bs-target="#report-nav-sub1" data-bs-toggle="collapse" href="#">
  ...
  <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-3" data-bs-target="#report-nav-sub2" data-bs-toggle="collapse" href="#">
  ...
  <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-4" data-bs-target="#report-nav-sub3" data-bs-toggle="collapse" href="#">
  ...
  <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-5" data-bs-target="#report-nav-sub4" data-bs-toggle="collapse" href="#">
   ...
   <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-6" data-bs-target="#report-nav-sub5" data-bs-toggle="collapse" href="#">
   ...
   <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-7" data-bs-target="#report-nav-sub6" data-bs-toggle="collapse" href="#">
  ...
  <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-8" data-bs-target="#report-nav-sub7" data-bs-toggle="collapse" href="#">
    ...
    <li>
        <a className="animation-forwards animate-delay-9" href="components-buttons.html">
          <i className="bi bi-circle"></i><span>Site Health Report</span>
        </a>
      </li>
   <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-10" data-bs-target="#report-nav-sub8" data-bs-toggle="collapse" href="#">
  ...
  <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-11" data-bs-target="#report-nav-sub9" data-bs-toggle="collapse" href="#">
  ...
  <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-5" data-bs-target="#utilities-nav" data-bs-toggle="collapse" href="#">
  ...
  <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-6" data-bs-target="#Status-nav" data-bs-toggle="collapse" href="#">
  ...
  <li className="nav-item">
    <a className="nav-link collapsed animation-forwards animate-delay-7" data-bs-target="#List-nav" data-bs-toggle="collapse" href="#">
